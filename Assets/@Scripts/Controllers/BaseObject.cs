...
public class BaseObject : InitBase
{
    ...
    public float CapsuleYSize { get { return Collider?.size.y ?? 0.0f; } }
    public Vector3 CenterPosition { get { return transform.position + Vector3.up * CapsuleYSize/2; } }
    ...
    public override bool Init()
    {
        ...
        Collider = gameObject.GetOrAddComponent<CapsuleCollider2D>();
